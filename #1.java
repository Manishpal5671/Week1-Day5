...
//1. Make necessary source code changes in Builder design pattern, to add honey ingredient as well?
...
class Cake {
    ...
    public static class Builder {
        ...
        public Builder honey(int spoon) {this.honey = spoon; return this;}
	...
	public String toString() {
		return "Cake [sugar=" + sugar + ", butter=" + butter + ", eggs=" + eggs + ", vanila=" + vanila + ", flour="
				+ flour + ", bakingpowder=" + bakingpowder + ", milk=" + milk + ", cherry=" + cherry + ", honey="
				+ honey + "]";
	} 
